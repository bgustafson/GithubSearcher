...
public class UserRepo implements Parcelable
{
    ...
    public final static Parcelable.Creator<UserRepo> CREATOR = new Creator<UserRepo>() {


        @SuppressWarnings({
                "unchecked"
        })
        public UserRepo createFromParcel(Parcel in) {
            ...
            instance.homepage = ((Object) in.readValue((Object.class.getClassLoader())));
        ...
        public UserRepo[] newArray(int size) {
            return (new UserRepo[size]);
        }
